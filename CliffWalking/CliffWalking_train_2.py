...
fig.suptitle(
    "CliffWalking-v1 — Clipped TD Error Sweep (Max Ep=5000)",
    fontsize=14,
    fontweight="bold",
)
...
ax2 = axes[1]
highlight_taus = [-2.0, -1.0, 0.0, 0.25, 0.5, 0.75]
...
plt.tight_layout()
plt.savefig("figure_cliffwalking_2.png", dpi=150, bbox_inches="tight")
print("\nPlot saved to figure_cliffwalking_2.png")
plt.show()
...
with open("aucl_results_CliffWalking_2.pkl", "wb") as f:
