...
fig.suptitle(
    "CliffWalking-v1 — Clipped TD Error Sweep (Max Ep=2000)",
    fontsize=14,
    fontweight="bold",
)
...
plt.tight_layout()
plt.savefig("figure_cliffwalking_3.png", dpi=150, bbox_inches="tight")
print("\nPlot saved to figure_cliffwalking_3.png")
plt.show()
...
with open("aucl_results_CliffWalking_3.pkl", "wb") as f:
