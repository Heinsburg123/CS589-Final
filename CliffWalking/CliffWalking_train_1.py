    ...
    for i in range(MAX_EPISODES):
        ...
        for t in range(500): # or 200 depending on env
            if random.random() < epsilon:
                ...
                q_vals = [get_q(q_table, state, a) for a in range(4)]
            ...
            best_next = max([get_q(q_table, next_state, a) for a in range(4)])
...
fig.suptitle('CliffWalking-v1 — Clipped TD Error Sweep (Max Ep=10000)', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('figure_cliffwalking_1.png', dpi=150, bbox_inches='tight')
print("\nPlot saved to figure_cliffwalking_1.png")
plt.show()
...
with open("aucl_results_CliffWalking_1.pkl", "wb") as f:
