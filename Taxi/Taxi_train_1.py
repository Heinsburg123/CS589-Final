...
fig.suptitle('Taxi-v4 — Clipped TD Error Sweep (Max Ep=20000)', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig('figure_taxi_1.png', dpi=150, bbox_inches='tight')
print("\nPlot saved to figure_taxi_1.png")
plt.show()
...
with open("aucl_results_Taxi_1.pkl", "wb") as f:
