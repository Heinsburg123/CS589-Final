    ...
    for i in range(MAX_EPISODES):
        ...
        for t in range(500):  # or 200 depending on env
            if random.random() < epsilon:
                ...
                q_vals = [get_q(q_table, state, a) for a in range(6)]
            ...
            best_next = max([get_q(q_table, next_state, a) for a in range(6)])
...
fig.suptitle(
    "Taxi-v4 — Clipped TD Error Sweep (Max Ep=10000)", fontsize=14, fontweight="bold"
)
...
plt.tight_layout()
plt.savefig("figure_taxi_2.png", dpi=150, bbox_inches="tight")
print("\nPlot saved to figure_taxi_2.png")
plt.show()
...
with open("aucl_results_Taxi_2.pkl", "wb") as f:
