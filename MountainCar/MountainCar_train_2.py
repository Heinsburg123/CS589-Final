...
fig.suptitle(
    "MountainCar-v0 — Clipped TD Error Sweep (Max Ep=20000)",
    fontsize=14,
    fontweight="bold",
)
...
plt.tight_layout()
plt.savefig("figure_mountaincar_2.png", dpi=150, bbox_inches="tight")
print("\nPlot saved to figure_mountaincar_2.png")
plt.show()
...
with open("aucl_results_MountainCar_2.pkl", "wb") as f:
